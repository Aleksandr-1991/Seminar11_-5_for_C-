// №37: Найти произв. пар чисел в 1мерном массиве. Парой считаем 1ый и последний элемент, 2й и предпоследний...
// Результат запишите в новом массиве. [1 2 3 4 5] -> [5 8];   [6 7 3 6] -> [36 21].
